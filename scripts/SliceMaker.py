...
parser.add_argument('--in_path', type=str, default='/home/vandangorade/ISBI24/DKD/data/LITS/Train/')
parser.add_argument('--out_path', type=str, default='/home/vandangorade/ISBI24/DKD/lits19/train/')
